...
open class BoardItemsAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.findViewById<TextView>(R.id.tv_created_by).text = "Được tạo bởi ${model.createdBy}"
    ...
    fun setOnClickListenerAdapter(onClickListener: OnClickListener) {
